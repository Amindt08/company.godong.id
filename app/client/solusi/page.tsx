...
<section className="flex flex-col sm:flex-row items-center justify-start p-8 bg-gray-100">
    <div className="text-left max-w-xl ml-auto mb-8 sm:mb-0">
        <h1 className="text-3xl font-bold text-gray-800 mb-4">Solusi Menyeluruh</h1>
        <p className="text-1xl text-gray-600">
            Kami menyediakan layanan “Solusi Menyeluruh” untuk pelanggan godong.id. Simak pertanyaan yang sering diajukan terkait layanan “Solusi Menyeluruh” berikut.
        </p>
    </div>
                ...
                <section className="p-8 bg-white flex justify-center">
                    <div className="w-full max-w-3xl">
                        ...
                        {faqs[currentPage].map((faq: FAQ, index: number) => (
                            <div
                                key={index}
                                className={`p-4 mb-4 text-lg border rounded-lg ${openQuestionIndex === index ? 'bg-gray-50' : 'bg-white'}`}
                            >
                                <h3
