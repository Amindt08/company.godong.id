...
const Orientasi = () => {
    ...
    return (
        ...
        <h1 className="text-4xl font-bold text-gray-800 mb-4">Orientasi</h1>
        <p className="text-1xl text-gray-600">
            Kami menyediakan layanan “Orientasi” untuk pelanggan godong.id. Simak pertanyaan yang sering diajukan terkait layanan “Orientasi” berikut.
        </p>
    </div>
    <div className="w-full sm:w-4/5 md:w-1/2 xl:w-2/5 ml-auto">
        ...
        />
                ...
                <section className="flex items-center justify-center space-x-4 py-6">
                    ...
                    <button
                        className="px-4 text-sm py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400 disabled:opacity-50"
                        onClick={() => handlePageChange(currentPage + 1)}
