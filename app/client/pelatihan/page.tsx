...
<section className="flex flex-col sm:flex-row items-center justify-start p-8 bg-gray-100">
    <div className="text-left max-w-xl ml-auto mb-8 sm:mb-0">
        <h1 className="text-4xl font-bold text-gray-800 mb-4">Pelatihan Produk</h1>
        <p className="text-1xl text-gray-600">
            Kami menyediakan layanan “Pelatihan Produk” untuk pelanggan godong.id. Simak pertanyaan yang sering diajukan terkait layanan “Pelatihan Produk” berikut.
        </p>
    </div>
